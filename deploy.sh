...
ssh nathaniel@blog.symer.io "cd /deploy/blog.symer.io.new; tar zxvf blog.deploy; rm blog.deploy; mv blog.symer.io blog.symer.io.old; mv blog.symer.io.new blog.symer.io; sudo /etc/init.d/blog restart;"
